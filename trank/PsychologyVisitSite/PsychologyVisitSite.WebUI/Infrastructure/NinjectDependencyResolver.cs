...
namespace PsychologyVisitSite.WebUI.Infrastructure
{
    ...
    public class NinjectDependencyResolver : IDependencyResolver
    {
        ...
        private void AddBindings()
        {
            ...
            mockEvents.Setup(m => m.Events).Returns(new List<MeetingEvent>
            {
                new MeetingEvent { Id = 1, Name = "Алтарь Афродиты", Price = 300, Category = "Тренинги", 
                    Description = "Цель тренинга Алтарь Афродиты - запустить магический женский процесс, чтобы открыть в себе энергию страсти и чувственности. \r\n"
                ...
                new MeetingEvent { Id = 2, Name = "Дорогу осилит идущая: семь дорог женственности ", Price = 200, Category = "Тренинги" },
                new MeetingEvent { Id = 3, Name = "Стрела Артемиды", Price = 300, Category = "Мастер-классы" },
                new MeetingEvent
                    {
                        Id = 4, Name = "Дочки-матери ", Price = 100, Category = "Тематически встречи",  
            ...
            mockRegistration.Setup(m => m.Registrations).Returns(
                new List<RegistrationForm>
                    {
            ...
            this.kernel.Bind<IRegistrationRepository>().ToConstant(mockRegistration.Object).WithConstructorArgument(efDbContext);
